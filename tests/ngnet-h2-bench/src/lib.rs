...
//! protocol and wrapper CPU work, never the kernel. See `docs/h2/benchmarks/interpreting.md`
...
//! `docs/h2/benchmarks/controls.md`.
//!
...
/// bar. See `docs/h2/benchmarks/findings/handing-bodies-over.md`.
