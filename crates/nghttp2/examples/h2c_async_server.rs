...
//!
//! ```text
//! cargo run -p nghttp2 --features tokio --example h2c_async_server
...
use nghttp2::http::transport::TokioIo;
...
async fn next_frame(body: &mut IncomingBody) -> Option<Result<Frame<Bytes>, nghttp2::http::Error>> {
