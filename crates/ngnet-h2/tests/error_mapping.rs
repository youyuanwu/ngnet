...
use ngnet_h2::{ALL_NATIVE_CODES, Error, ErrorKind};
...
/// hatch so the test does not declare `ngnet-h2-sys` as a dependency (Spec SC-007).
mod ngnet_h2_sys_codes {
    pub const NOMEM: i32 = ngnet_h2::raw::NGHTTP2_ERR_NOMEM;
    pub const CALLBACK_FAILURE: i32 = ngnet_h2::raw::NGHTTP2_ERR_CALLBACK_FAILURE;
    pub const BAD_CLIENT_MAGIC: i32 = ngnet_h2::raw::NGHTTP2_ERR_BAD_CLIENT_MAGIC;
    pub const FLOODED: i32 = ngnet_h2::raw::NGHTTP2_ERR_FLOODED;
    pub const TOO_MANY_CONTINUATIONS: i32 = ngnet_h2::raw::NGHTTP2_ERR_TOO_MANY_CONTINUATIONS;
    pub const INVALID_ARGUMENT: i32 = ngnet_h2::raw::NGHTTP2_ERR_INVALID_ARGUMENT;
}
