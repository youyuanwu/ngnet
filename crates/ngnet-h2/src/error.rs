...
impl NativeCode {
    ...
    pub fn describe(self) -> Option<&'static str> {
        ...
        let ptr = unsafe { ngnet_h2_sys::nghttp2_strerror(self.0) };
        if ptr.is_null() {
            return None;
        }
...
pub const ALL_NATIVE_CODES: &[NativeCode] = &[
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INVALID_ARGUMENT),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_BUFFER_ERROR),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_UNSUPPORTED_VERSION),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_WOULDBLOCK),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_PROTO),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INVALID_FRAME),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_EOF),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_DEFERRED),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_STREAM_ID_NOT_AVAILABLE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_STREAM_CLOSED),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_STREAM_CLOSING),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_STREAM_SHUT_WR),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INVALID_STREAM_ID),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INVALID_STREAM_STATE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_DEFERRED_DATA_EXIST),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_START_STREAM_NOT_ALLOWED),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_GOAWAY_ALREADY_SENT),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INVALID_HEADER_BLOCK),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INVALID_STATE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_TEMPORAL_CALLBACK_FAILURE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_FRAME_SIZE_ERROR),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_HEADER_COMP),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_FLOW_CONTROL),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INSUFF_BUFSIZE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_PAUSE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_TOO_MANY_INFLIGHT_SETTINGS),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_PUSH_DISABLED),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_DATA_EXIST),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_SESSION_CLOSING),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_HTTP_HEADER),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_HTTP_MESSAGING),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_REFUSED_STREAM),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_INTERNAL),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_CANCEL),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_SETTINGS_EXPECTED),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_TOO_MANY_SETTINGS),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_FATAL),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_NOMEM),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_CALLBACK_FAILURE),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_BAD_CLIENT_MAGIC),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_FLOODED),
    NativeCode::new(ngnet_h2_sys::NGHTTP2_ERR_TOO_MANY_CONTINUATIONS),
];
...
impl ErrorCode {
    ...
    pub const NO_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_NO_ERROR);
    /// The endpoint detected an unspecific protocol error.
    pub const PROTOCOL_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_PROTOCOL_ERROR);
    /// The endpoint encountered an unexpected internal error.
    pub const INTERNAL_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_INTERNAL_ERROR);
    /// The endpoint detected that its peer violated the flow-control protocol.
    pub const FLOW_CONTROL_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_FLOW_CONTROL_ERROR);
    /// The endpoint sent a `SETTINGS` frame but did not receive a response in time.
    pub const SETTINGS_TIMEOUT: Self = Self(ngnet_h2_sys::NGHTTP2_SETTINGS_TIMEOUT);
    /// The endpoint received a frame after a stream was half-closed.
    pub const STREAM_CLOSED: Self = Self(ngnet_h2_sys::NGHTTP2_STREAM_CLOSED);
    /// The endpoint received a frame with an invalid size.
    pub const FRAME_SIZE_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_FRAME_SIZE_ERROR);
    /// The endpoint refused the stream before any processing had been done.
    pub const REFUSED_STREAM: Self = Self(ngnet_h2_sys::NGHTTP2_REFUSED_STREAM);
    /// The endpoint no longer needs the stream.
    pub const CANCEL: Self = Self(ngnet_h2_sys::NGHTTP2_CANCEL);
    /// The endpoint is unable to maintain the header compression context.
    pub const COMPRESSION_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_COMPRESSION_ERROR);
    /// The connection established in response to a `CONNECT` request was reset.
    pub const CONNECT_ERROR: Self = Self(ngnet_h2_sys::NGHTTP2_CONNECT_ERROR);
    /// The endpoint detected that its peer is exhibiting a behavior causing load.
    pub const ENHANCE_YOUR_CALM: Self = Self(ngnet_h2_sys::NGHTTP2_ENHANCE_YOUR_CALM);
    /// The underlying transport has properties that do not meet minimum requirements.
    pub const INADEQUATE_SECURITY: Self = Self(ngnet_h2_sys::NGHTTP2_INADEQUATE_SECURITY);
    /// The endpoint requires that HTTP/1.1 be used instead of HTTP/2.
    pub const HTTP_1_1_REQUIRED: Self = Self(ngnet_h2_sys::NGHTTP2_HTTP_1_1_REQUIRED);
