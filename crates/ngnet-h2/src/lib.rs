...
//!
//! ```
//! use ngnet_h2::{BytesBody, Header, HeaderAction, Session, SessionBuilder};
//!
...
//!
//! ```
//! # use ngnet_h2::{HeaderAction, SessionBuilder};
...
//!
//! ```compile_fail
//! # use ngnet_h2::{HeaderAction, Session, SessionBuilder};
