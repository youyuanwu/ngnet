...
| [`ngnet-h3-quinn`](crates/ngnet-h3-quinn) | Published at 0.0.x alongside `ngnet-h3`. Implements its transport trait for an established [Quinn](https://github.com/quinn-rs/quinn) connection while leaving endpoint and TLS policy to the caller. |
