...
| [03-native-h3-s9-timer-wake](03-native-h3-s9-timer-wake.md) | 2026-09-03 | `fb8257d` | Native large-body S9 — reproduced timer-wake stall and two clean 100-process post-change schedules. **Reliability only; no timing claimed** |
