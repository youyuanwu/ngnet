...
| [15-qmux-h3-shared-snapshot](15-qmux-h3-shared-snapshot.md) | 2026-08-28 | `c171f4f` against `c6f1191`, then `5477450` | Coherent shared work — **155 → 29 operations; −7.64% / −6.24% incremental serial** |
