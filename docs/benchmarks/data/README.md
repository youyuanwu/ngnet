...
| [`epyc-7763-azure`](epyc-7763-azure/) | Current host. AMD EPYC 7763, `Standard_D4as_v5`, 4 vCPU, no cpufreq governor exposed. **Cannot presently measure timings**: never idle (a Kubernetes control plane and two unrelated processes ran throughout), and an unchanged control arm drifted 4.2x within one session. Useful for correctness and liveness work. | 5 |
...
| [04-native-h3-s9-root-cause](epyc-7763-azure/04-native-h3-s9-root-cause.md) | epyc-7763-azure | 2026-09-04 | Native large-body S9 root-cause follow-up | pump/retry seam corrected; pre-readiness residual blocks a resolution claim |
| [05-native-h3-s9-qualification](epyc-7763-azure/05-native-h3-s9-qualification.md) | epyc-7763-azure | 2026-09-05 | Native large-body S9 final qualification | typed pre-readiness record and complete 100-process-per-size schedules; S9 resolved |
