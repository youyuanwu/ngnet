...
| [`epyc-7763-azure`](epyc-7763-azure/) | Current host. AMD EPYC 7763, `Standard_D4as_v5`, 4 vCPU, no cpufreq governor exposed. **Cannot presently measure timings**: never idle (a Kubernetes control plane and two unrelated processes ran throughout), and an unchanged control arm drifted 4.2x within one session. Useful for correctness and liveness work. | 4 |
