...
and the encoder copies them into the record buffer
(`crates/ngnet-qmux-sys/vendor/dwnx/lib/dwnx_frame.c:157`). The
...
outside `crates/ngnet-qmux-sys/vendor/dwnx` — would retake the second half. Short of one of
those two, the answer is
