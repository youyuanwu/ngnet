...
stack's, and no test here is `#[ignore]`d for it. A later native investigation reproduced the timer-wake mechanism and completed two independent
100-process post-change schedules. The distinction remains important because this adapter's
lost-FIN defect and the native timer defect have separate causes and regressions; see
