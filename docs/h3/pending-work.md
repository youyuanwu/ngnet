...
observed both armed and unarmed release-mode stalls. The reproduced timer-wake mechanism was
subsequently corrected and passed two independent 100-process reliability schedules, recorded
